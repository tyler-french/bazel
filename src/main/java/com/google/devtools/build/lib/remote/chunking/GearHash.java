...
/**
 * Gear hash table shared by content-defined chunking algorithms (FastCDC, RepMaxCDC).
 *
 * <p>GEAR[i] = high 64 bits of MD5(byte(i)) for i in 0..255. This is the standard Gear hash table
 * specified in the Remote Execution API for content-defined chunking.
 */
final class GearHash {

  /** The size of the Gear rolling hash window in bytes. */
